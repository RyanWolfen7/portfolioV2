...
const guitarDetails = ['Singer Songwriter', 'I', guitar, ['Write Songs', 'Play Guitar', 'Sing'] ]
const infantryDetails = ['Infantry Skills', `I'm an expert in`, infantry, ['Close Combat', 'Small Unit Tactics', 'Fire Arms', 'Jungle Warefare', 'Training', 'Leadership', 'First Aid']]
const photographyDetails = ['Photography', 'I studied', photography, ['35mm Film', 'Black and White Film', 'Film Exposure', 'Printing']]
const poetryDetails = ['Poetry', 'I like writting', poetry, ['Short Poems', 'Haikus', `Many of my poems are inspired by what I'm feeling in the moment`, 'https://hellopoetry.com/ryan-clark/']]
